                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <a href="modifierVente.php?idvente=<?= $vaccination['idvaccination'] ?>" class="px-2" title="Modifier la ventes"><i class="far fa-edit"></i></a>
                                                            <a href="javascript:void(0);" class="suprimerVente<?= $i ?> px-2 text-danger" title="Suprimer vente"><i class="fa fa-cut"></i></a>
                                                        </td>
                                                    </tr>
