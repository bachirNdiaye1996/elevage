<?php
    ...
    if(isset($_POST['CreerVente'])){
        ...
        header("location: vente.php?idreceptionpoussin=$idreceptionpoussin");
        exit;
    }
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end">
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="vente.php?idreceptionpoussin=<?= $_GET['idreceptionpoussin'] ?>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
