                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                                    ...
                                                    <input class="form-control" type="text" name="idreceptionpoussin" value="<?php echo $row['idreceptionvente'];?>" id="validationDefault25" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 text-end">
                                                <div class="col-md-8 align-items-center col-md-12 text-end">
                                                    ...
                                                    <div class="d-flex gap-2 pt-4">                           
                                                        <a class="btn btn-danger  w-lg bouton mr-3" href="vente.php">Annuler</a>
                                                        <input class="btn btn-success  w-lg bouton mr-3" name="modifierVente" type="submit" value="Modifier">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
