                                            ...
                                            <div class="row">
                                                <div class="col-md-2 ml-5 mr-5 mt-3">
                                                    <div class="mb-5 text-start">
                                                        ...
                                                        <input class="form-control" type="text" name="nombrepoulet" value="" id="validationDefault01" placeholder="Nombre de sacs">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Lieu de ventes</label>
                                                        <input class="form-control" type="text" name="lieuvente" value="" id="validationDefault02" required placeholder="Mettez le nom du fournisseur">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                        ...
                                                        <input class="form-control" type="text" name="vendeur" value="" id="validationDefault02" required placeholder="Mettez le nom du fournisseur">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 ml-5 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Client</label>
                                                        <input class="form-control" type="text" name="client" value="" id="validationDefault03" placeholder="Mettez le prix total">
                                                    </div>
                                                </div>
