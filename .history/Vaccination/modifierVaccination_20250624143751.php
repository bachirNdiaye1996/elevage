...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        $sql = "select * from achataliment where idvaccination=$id";
        $result = $db->query($sql);
        $row = $result->fetch();
        while(!$row){
        ...
        if(isset($_POST['modifierAchat'])){
            $nombresac=htmlspecialchars($_POST['nombresac']);
            ...
            $sql = "UPDATE `achataliment` SET `nombresac` = '$nombresac', `fournisseur` = '$fournisseur', `prix` = '$prix',`commentaire` = '$commentaire',`dateachat` = '$dateachat',`idreceptionpoussin` = '$idreceptionpoussin'
             WHERE `idvaccination` = ?;";
            //$result = $db->query($sql); 
            $sth = $db->prepare($sql);    
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myExtraLargeModalLabel">Modifier l'Achat</h5>
                                        ...
                                        <div class="row">
                                                <div class="col-md-2 ml-5 mr-5 mt-3">
                                                    <div class="mb-5 text-start">
                                                        <label class="form-label fw-bold" for="nom">Nombre de sacs</label> 
                                                        <input class="form-control" type="text" name="nombresac" value="<?php echo $row['nombresac'];?>" id="validationDefault01" placeholder="Nombre de sacs">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Fournisseur</label>
                                                        <input class="form-control" type="text" name="fournisseur" value="<?php echo $row['fournisseur'];?>" id="validationDefault02" required placeholder="Mettez le nom du fournisseur">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 mt-3 ml-5 mb-5">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Date d'achat</label>
                                                        <input class="form-control" type="date" name="dateachat" value="<?php echo $row['dateachat'];?>" id="validationDefault25" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 ml-5 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Numéro bande</label>
                                                        <input class="form-control" type="text" name="idreceptionpoussin" value="<?php echo $row['idreceptionpoussin'];?>" id="validationDefault03" placeholder="Mettez le numéro de la bande">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12 text-end">
                                                <div class="col-md-8 align-items-center col-md-12 text-end">
                                                    <?php //if(){?> <script>    Swal.fire({
                                                        text: 'reception enregistrée avec succès merci!',
                                                        icon: 'success',
                                                        timer: 2000,
                                                        showConfirmButton: false,
                                                        });</script> <?php //} ?>
                                                    <div class="d-flex gap-2 pt-4">                           
                                                        <a class="btn btn-danger  w-lg bouton mr-3" href="achataliment.php">Annuler</a>
                                                        <input class="btn btn-success  w-lg bouton mr-3" name="modifierAchat" type="submit" value="Modifier">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
