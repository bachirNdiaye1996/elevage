                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style=""> 
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="vaccination.php?idreceptionpoussin=<?= $achataliment['idreceptionpoussin'] ?>" class="link-offset-2 link-underline"><?= 'VACC_0'.$fichevaccination['idfichevaccination'] ?></a>     
                                                        </td>
