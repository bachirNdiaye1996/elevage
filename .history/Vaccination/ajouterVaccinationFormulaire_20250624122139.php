<?php
    ...
    if(isset($_POST['CreerVaccination'])){
        $nombresac=htmlspecialchars($_POST['nombresac']);
        $prix=htmlspecialchars($_POST['prix']);
        $fournisseur=htmlspecialchars($_POST['nomvaccin']);
        ...
        $insertUser=$db->prepare("INSERT INTO `vaccination` (`idvaccination`,`actif`,`nomvaccin`,`idreceptionpoussin`,`prix`,`quantite`,`datecreation`,`datevaccination`,`commentaire`) 
        VALUES (NULL, 1, ?, ?, ?, current_timestamp(), ?, ?, ?, 1);");
        $insertUser->execute(array($nombresac,$prix,$fournisseur,$dateachat,$idreceptionpoussin,$commentaire));
                            ...
                            <div class="modal-dialog-centered">
                                <div class="modal-content col-lg-12">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myExtraLargeModalLabel">Ajouter un achat d'aliment</h5>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 ml-5 mr-5 mt-3">
                                                    <div class="mb-5 text-start">
                                                        ...
                                                        <input class="form-control" type="text" name="nombresac" value="" id="validationDefault01" placeholder="Nombre de sacs">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Fournisseur</label>
                                                        <input class="form-control" type="text" name="fournisseur" value="" id="validationDefault02" required placeholder="Mettez le nom du fournisseur">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 mt-3 ml-5 mb-5">
                                                    <div class="mb-1 text-start">
                                                        ...
                                                        <input class="form-control" type="date" name="dateachat" value="" id="validationDefault25" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 ml-5 mt-3">
                                                    <div class="mb-1 text-start">
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end">
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="achataliment.php ?>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
                                                            <input class="btn btn-success  w-lg bouton mr-3" name="CreerVaccination" type="submit" value="ENREGISTRER">
                                                        </div>
                                                        <hr/>
                                                    </div>
                                                </div>
