<?php
    ...
    if(isset($_POST['CreerVaccination'])){
        ...
        header("location: vaccination.php?idreceptionpoussin=$idreceptionpoussin");
        exit;
    }
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 ml-5 mr-5 mt-3">
                                                    <div class="mb-5 text-start">
                                                        ...
                                                        <input class="form-control" type="text" name="nomvaccin" value="" id="validationDefault01" placeholder="Nombre de sacs">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Quantité</label>
                                                        <input class="form-control" type="text" name="quantite" value="" id="validationDefault02" required placeholder="Mettez le nom du fournisseur">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 mt-3 ml-5 mb-5">
                                                    <div class="mb-1 text-start">
                                                        ...
                                                        <input class="form-control" type="date" name="datevaccination" value="" id="validationDefault25" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 ml-5 mt-3">
                                                    <div class="mb-1 text-start">
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end">
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="vaccination.php?idreceptionpoussin=<?= $idreceptionpoussin ?>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
