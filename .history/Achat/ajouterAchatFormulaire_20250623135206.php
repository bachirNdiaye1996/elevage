<?php
    ...
    if(isset($_POST['CreerReception'])){
        ...
        $insertUser->execute(array($nombresac,$prix,$fournisseur,$dateachat,$dateachat,$idreceptionpoussin,$commentaire));
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mt-3 ml-5 mb-5">
                                                    <div class="mb-1 text-start">
                                                        ...
                                                        <input class="form-control" type="date" name="idreceptionpoussin" value="" id="validationDefault25" required>
                                                    </div>
                                                </div>
