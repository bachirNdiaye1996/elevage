                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseReception" class="collapse show" aria-labelledby="headingReception"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item active" href="../Achat/ficheachataliment.php">Achat aliment</a>
                            ...
                            <div class="card position-relative">
                                ...
                                <div class="row m-2">
                                    <div class="table-responsive">
                                        ...
                                        <a href="ajouterAchatFormulaire.php?idreceptionpoussin=<?= $_GET['idreceptionpoussin'] ?>" class="btn btn-success w-lg bouton mt-5 mb-2 ml-5"><i class="fa fa-plus me-1"></i>Ajouter achat</a>     
