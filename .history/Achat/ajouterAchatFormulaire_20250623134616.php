<?php
    ...
    if(isset($_POST['CreerReception'])){
        ...
        $insertUser=$db->prepare("INSERT INTO `achataliment ` (`idachataliment `,`nombresac`,`prix`,`fournisseur`,`datecreation`,`dateachat`,`commentaire`,`actif`) 
        VALUES (NULL, ?, ?, ?, current_timestamp(), ?, ?, ?, 1);");
        $insertUser->execute(array($nombresac,$prix,$fournisseur,$dateachat, $dateachat, $prix,$commentaire));
