                            ...
                            <div class="card position-relative">
                                ...
                                <div class="row m-2">
                                    <div class="table-responsive">
                                        ...
                                        <a href="ajouterAchatFormulaire.php?idreceptionpoussin=<?= $achataliment['idreceptionpoussin'] ?>" class="link-offset-2 link-underline"><?= 'ACHAT_0'.$achataliment['idficheachataliment'] ?></a>     
                                        <a href="" class="btn btn-success w-lg bouton mt-5 mb-2 ml-5"><i class="fa fa-plus me-1"></i> Ajouter achat</a>
