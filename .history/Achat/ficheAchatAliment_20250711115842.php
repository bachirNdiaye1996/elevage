                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style=""> 
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="achataliment.php?idficheachataliment=<?= $achataliment['idficheachataliment'] ?>" class="link-offset-2 link-underline"><?= 'ACHAT_0'.$achataliment['idficheachataliment'] ?></a>     
                                                        </td>
