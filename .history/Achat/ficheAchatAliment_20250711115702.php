...
//** Debut select des receptions
    $sql = "SELECT * FROM `ficheachataliment` where `actif`=1 ORDER BY `idficheachataliment` DESC;";
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style=""> 
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="achataliment.php?idficheachataliment=<?= 'ACHAT_0'.$achataliment['idficheachataliment'] ?>" class="link-offset-2 link-underline"><?php echo "CRAN-".$cranteuseq1['idfichecranteuseq1']; ?></a>     
                                                        </td>
