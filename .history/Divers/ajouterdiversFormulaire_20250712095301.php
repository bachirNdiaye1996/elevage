...
<?php
    ...
    if(isset($_POST['CreerDivers'])){
        ...
        $insertUser->execute(array($nom,$quantite,$prix,$datedivers,$idreceptionpoussin,$commentaire));
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 ml-5 mr-5 mt-3">
                                                    <div class="mb-5 text-start">
                                                        ...
                                                        <input class="form-control" type="text" name="nom" value="" id="validationDefault01" placeholder="Divers">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Quantités</label>
                                                        <input class="form-control" type="text" name="quantite" value="" id="validationDefault02" required placeholder="Mettez la quantité">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 mt-3 ml-5 mb-5">
                                                    <div class="mb-1 text-start">
                                                        ...
                                                        <input class="form-control" type="date" name="datedivers" value="" id="validationDefault25" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end">
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="divers.php?idreceptionpoussin=<?= $_GET['idreceptionpoussin'] ?>>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
                                                            <input class="btn btn-success  w-lg bouton mr-3" name="CreerDivers" type="submit" value="ENREGISTRER">
                                                        </div>
                                                        <hr/>
                                                    </div>
                                                </div>
