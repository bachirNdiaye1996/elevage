                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 mr-2 mt-3">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Qantités</label>
                                                    <input class="form-control" type="text" name="quantite" value="<?php echo $row['lieudette'];?>" id="validationDefault02" required placeholder="Mettez le lieu de la dette">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mr-2 mt-3">
                                                <div class="mb-1 text-start">
