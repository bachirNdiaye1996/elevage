...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['modifierDivers'])){
            $nombrepoulet=htmlspecialchars($_POST['nombrepoulet']);
            $prix=htmlspecialchars($_POST['prix']);
            $lieudette=htmlspecialchars($_POST['lieudette']);
            $paye=htmlspecialchars($_POST['paye']);
            $vendeur=htmlspecialchars($_POST['vendeur']);
            $client=htmlspecialchars($_POST['client']);
            $datedette=htmlspecialchars($_POST['datedette']);
            $commentaire=htmlspecialchars($_POST['commentaire']);
            $idreceptionpoussin=htmlspecialchars($_POST['idreceptionpoussin']);

            $sql = "UPDATE `dette` SET `nombrepoulet` = '$nombrepoulet', `lieudette` = '$lieudette', `prix` = '$prix',`paye` = '$paye',`commentaire` = '$commentaire'
            ,`datedette` = '$datedette',`vendeur` = '$vendeur',`client` = '$client',`idreceptionpoussin` = '$idreceptionpoussin' WHERE `iddette` = ?;";
            //$result = $db->query($sql); 
            $sth = $db->prepare($sql);    
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myExtraLargeModalLabel">Modifier la dette</h5>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 mr-2 mt-3">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Lieu de dette</label>
                                                    <input class="form-control" type="text" name="lieudette" value="<?php echo $row['lieudette'];?>" id="validationDefault02" required placeholder="Mettez le lieu de la dette">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mr-2 mt-3">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Payabilité</label>
                                                    <input class="form-control" type="text" name="paye" value="<?php echo $row['paye'];?>" id="validationDefault02" required placeholder="Mettez la payabilité">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Date de dette</label>
                                                    <input class="form-control" type="date" name="datedette" value="<?php echo $row['datedette'];?>" id="validationDefault25" required>
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                            ...
                                            <div class="col-md-12 text-end">
                                                <div class="col-md-8 align-items-center col-md-12 text-end">
                                                    <?php //if(){?> <script>    Swal.fire({
                                                        text: 'Dette enregistrée avec succès merci!',
                                                        icon: 'success',
                                                        timer: 2000,
                                                        showConfirmButton: false,
                                                        });</script> <?php //} ?>
                                                    <div class="d-flex gap-2 pt-4">                           
                                                        <a class="btn btn-danger  w-lg bouton mr-3" href="dette.php">Annuler</a>
                                                        <input class="btn btn-success  w-lg bouton mr-3" name="modifierDivers" type="submit" value="Modifier">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
