...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['modifierDivers'])){
            ...
            $sql = "UPDATE `divers` SET `nom` = '$nom', `quantite` = '$quantite', `prix` = '$prix',`commentaire` = '$commentaire'
            ,`datedivers` = '$datedivers',`idreceptionpoussin` = '$idreceptionpoussin' WHERE `iddivers` = ?;";
            //$result = $db->query($sql); 
            $sth = $db->prepare($sql);    
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myExtraLargeModalLabel">Modifier divers</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 ml-5 mr-5 mt-3">
                                                <div class="mb-5 text-start">
                                                    <label class="form-label fw-bold" for="nom">Nom des divers</label> 
