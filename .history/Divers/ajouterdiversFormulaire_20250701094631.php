...
<?php
    ...
    if(isset($_POST['CreerDivers '])){
        ...
        $insertUser=$db->prepare("INSERT INTO `divers` (`iddivers`,`actif`,`nombrepoulet`,`prix`,`lieudette`,`vendeur`,`client`,`paye`,`idreceptionpoussin`,`commentaire`,`datedette`,`datecreation`) 
