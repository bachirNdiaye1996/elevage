...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['modifierDivers'])){
            ...
            $sql = "UPDATE `divers` SET `nombrepoulet` = '$nombrepoulet', `lieudette` = '$lieudette', `prix` = '$prix',`paye` = '$paye',`commentaire` = '$commentaire'
            ,`datedette` = '$datedette',`vendeur` = '$vendeur',`client` = '$client',`idreceptionpoussin` = '$idreceptionpoussin' WHERE `iddivers` = ?;";
            //$result = $db->query($sql); 
            $sth = $db->prepare($sql);    
