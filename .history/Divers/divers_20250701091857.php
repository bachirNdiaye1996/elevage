...
//** Debut select vaccination
    $sql = "SELECT * FROM `divers` where `actif`=1 ORDER BY `iddivers` DESC;";
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseReception" class="collapse show" aria-labelledby="headingReception"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item active" href="../divers/divers.php">divers</a>
                       ...
                       <div class="col-lg-12">
                            <div class="card position-relative">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Liste des diverss</h6>
                                </div>
                                <div class="row m-2">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style=""> <?= $divers['nombrepoulet'] ?> </td>
                                                        <td style=""> <?= $divers['prix'] ?> </td>
                                                        <td style=""> <?= $divers['lieudivers'] ?> </td>
                                                        <td style=""> <?= $divers['vendeur'] ?> </td>
                                                        <td style=""> <?= $divers['client'] ?> </td>
                                                        <td style=""> <?= $divers['paye'] ?> </td>
                                                        <td style=""> <?= $divers['datedivers'] ?> </td>
                                                        <td style=""> <?= $divers['datecreation'] ?> </td>
                                                        <td style=""> <?= $divers['idreceptionpoussin'] ?> </td>
                                                        <td style="text-align: center;">
                                                            <a href="modifierdivers.php?iddivers=<?= $divers['iddivers'] ?>" class="px-2" title="Modifier la divers"><i class="far fa-edit"></i></a>
                                                            <a href="javascript:void(0);" class="suprimerdivers<?= $i ?> px-2 text-danger" title="Suprimer la divers"><i class="fa fa-cut"></i></a>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <script>
                                                            ...
                                                            $(document).ready( function(){
                                                                $('.suprimerdivers<?= $i ?>').click(function(e) {
                                                                    ...
                                                                    Swal.fire({
                                                                    title: 'En es-tu sure?',
                                                                    text: 'Voulez-vous vraiment suprimer cette divers?',
                                                                    icon: 'warning',
                                                                    showCancelButton: true,
                                                                    confirmButtonColor: '#3085d6',
                                                                    cancelButtonColor: '#d33',
                                                                    confirmButtonText: "Suprimer la divers",
                                                                    }).then((result) => {
                                                                        if (result.isConfirmed) {                                                                                                                  
                                                                            $.ajax({
                                                                                    ...
                                                                                    success: function( response ) {
                                                                                        Swal.fire({
                                                                                            text: 'divers suprimé avec succes!',
                                                                                            icon: 'success',
                                                                                            timer: 3000,
                                                                                    ...
                                                                                    error: function( response ) {
                                                                                        $('#status').text('Impossible de supprimer cette divers : '+ response.status + " " + response.statusText);
