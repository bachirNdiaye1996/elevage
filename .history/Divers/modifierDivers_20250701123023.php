                                        ...
                                        <div class="row">
                                            <div class="col-md-2 ml-5 mr-5 mt-3">
                                                <div class="mb-5 text-start">
                                                    ...
                                                    <input class="form-control" type="text" name="nom" value="<?php echo $row['nom'];?>" id="validationDefault01" placeholder="Nombre de poulet">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mr-2 mt-3">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Qantités</label>
                                                    <input class="form-control" type="text" name="quantite" value="<?php echo $row['quantite'];?>" id="validationDefault02" required placeholder="Mettez le lieu de la dette">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mr-2 mt-3">
                                                <div class="mb-1 text-start">
