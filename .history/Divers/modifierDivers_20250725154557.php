...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['modifierDivers'])){
            ...
            header("location: divers.php?idreceptionpoussin=$id");
            exit;
        } 
    }
//Fin modif
                                    ...
                                    <form action="#" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Date divers</label>
                                                    <input class="form-control" type="date" name="datedivers" value="<?php echo $row['datedivers'];?>" id="validationDefault25" required>
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                            ...
                                            <div class="col-md-12 text-end">
                                                <div class="col-md-8 align-items-center col-md-12 text-end">
                                                    <?php //if(){?> <script>    Swal.fire({
                                                        text: 'Divers enregistrés avec succès merci!',
                                                        icon: 'success',
                                                        timer: 2000,
                                                        showConfirmButton: false,
                                                        });</script> <?php //} ?>
                                                    <div class="d-flex gap-2 pt-4">                           
                                                        <a class="btn btn-danger  w-lg bouton mr-3" href="divers.php">Annuler</a>
