                ...
                <li class="nav-item">
                    ...
                    <div id="collapseReception" class="collapse show" aria-labelledby="headingReception"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../stockage/reception.php">Réception poussin</a>
                            <a class="collapse-item" href="../stockage/receptionPlanifie.php">Achat aliment</a>
                            <a class="collapse-item" href="../stockage/transfert/transfert.php">Vacination</a>
                            <a class="collapse-item" href="../stockage/Exportation/exportation.php">Vente</a>
                            <a class="collapse-item" href="../stockage/stockage/stockage.php">Stockage frigo</a>
                            <a class="collapse-item" href="../stockage/graphe.php">Vente maison</a>
