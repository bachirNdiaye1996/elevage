<?php   
    ...
    $dt = time();
    $dty = date( "Y", $dt );  // On extrait le mois courant.
    printf($dty);

    //** Debut select des receptions
        $sql = "SELECT SUM(`nombrepousin`) as nombrepoussin, MONTH(`datecreation`) as mois FROM `receptionpoussin` WHERE `actif`=1 AND YEAR(`datecreation`)=$dty 
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Production Poulet</h6>
                                </div>
                                <div class="card-body">
                                    <div>
