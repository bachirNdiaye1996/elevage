<?php
    ...
    if(isset($_POST['CreerStockage'])){
        ...
        $insertUser=$db->prepare("INSERT INTO `stockagefrigo ` (`idstockagefrigo`,`actif`,`nombrepoulet`,`datestockagefrigo`,`datecreation`,`commentaire`,`idreceptionpoussin`) 
        VALUES (NULL, 1, ?, ?, current_timestamp(), ?, ?);");
        $insertUser->execute(array($nombrepoulet,$datestockagefrigo,$datemortalite,$commentaire,$idreceptionpoussin));
