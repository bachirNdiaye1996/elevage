<?php
    ...
    if(isset($_POST['CreerStockage'])){
        ...
        header("location: stockagefrigo.php?idreceptionpoussin=$idreceptionpoussin");
        exit;
    }
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mt-3 ml-5 mb-5">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Date stockage</label>
                                                        <input class="form-control" type="date" name="datestockagefrigo" value="" id="validationDefault25" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end">
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="stockageFrigo.php?idreceptionpoussin=<?= $_GET['idreceptionpoussin'] ?>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
