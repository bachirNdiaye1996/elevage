...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['modifierStockagefrigo'])){
            $nombrepoulet=htmlspecialchars($_POST['nombrepoulet']);
            $datestockagefrigo =htmlspecialchars($_POST['datestockagefrigo']);
            $commentaire=htmlspecialchars($_POST['commentaire']);
            $idreceptionpoussin=htmlspecialchars($_POST['idreceptionpoussin']);

            $sql = "UPDATE `stockagefrigo` SET `nombrepoulet` = '$nombrepoulet', `commentaire` = '$commentaire'
            ,`datestockagefrigo` = '$datestockagefrigo',`idreceptionpoussin` = '$idreceptionpoussin' WHERE `idstockagefrigo` = ?;";
            //$result = $db->query($sql); 
            $sth = $db->prepare($sql);    
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myExtraLargeModalLabel">Modifier le stockage dans le frigo</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 ml-5 mr-5 mt-3">
                                                <div class="mb-5 text-start">
                                                    ...
                                                    <input class="form-control" type="text" name="nombremort" value="<?php echo $row['nombremort'];?>" id="validationDefault01" placeholder="Nombre de poulet morts">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mr-2 mt-3">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Cause</label>
                                                    <input class="form-control" type="text" name="cause" value="<?php echo $row['cause'];?>" id="validationDefault02" required placeholder="Mettez la cause de la mortalité">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Date mortalité</label>
                                                    <input class="form-control" type="date" name="datemortalite" value="<?php echo $row['datemortalite'];?>" id="validationDefault25" required>
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                            ...
                                            <div class="col-md-12 text-end">
                                                <div class="col-md-8 align-items-center col-md-12 text-end">
                                                    ...
                                                    <div class="d-flex gap-2 pt-4">                           
                                                        ...
                                                        <input class="btn btn-success  w-lg bouton mr-3" name="modifierStockagefrigo" type="submit" value="Modifier">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
