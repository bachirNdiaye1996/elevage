                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style=""> 
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="achataliment.php?idreceptionpoussin=<?= $fichestockagefrigo['idreceptionpoussin'] ?>" class="link-offset-2 link-underline"><?= 'STOCK_0'.$fichestockagefrigo['idfichestockagefrigo'] ?></a>     
                                                        </td>
