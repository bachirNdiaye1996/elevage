                                        ...
                                        <div class="row">
                                            <div class="col-md-2 ml-5 mr-5 mt-3">
                                                <div class="mb-5 text-start">
                                                    <label class="form-label fw-bold" for="nom">Nombre de poulets</label> 
                                                    <input class="form-control" type="text" name="nombrepoulet" value="<?php echo $row['nombrepoulet'];?>" id="validationDefault01" placeholder="Nombre de poulets stockés">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Date du stockage</label>
                                                    <input class="form-control" type="date" name="datestockagefrigo" value="<?php echo $row['datestockagefrigo'];?>" id="validationDefault25" required>
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                            ...
                                            <div class="col-md-12 text-end">
                                                <div class="col-md-8 align-items-center col-md-12 text-end">
                                                    ...
                                                    <div class="d-flex gap-2 pt-4">                           
                                                        <a class="btn btn-danger  w-lg bouton mr-3" href="stockagefrigo.php">Annuler</a>
