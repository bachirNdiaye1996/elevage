                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style=""> <?= $stockagefrigo['datemortalite'] ?> </td>
                                                        <td style=""> <?= $stockagefrigo['datecreation'] ?> </td>
                                                        <td style=""> <?= $stockagefrigo['idreceptionpoussin'] ?> </td>
                                                        <td style="text-align: center;">
                                                            <a href="modifierStockagefrigo.php?idstockagefrigo=<?= $stockagefrigo['idmortalite'] ?>" class="px-2" title="Modifier lE stockage"><i class="far fa-edit"></i></a>
