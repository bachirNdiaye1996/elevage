...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['modifierStockagefrigo'])){
            ...
            $sql = "UPDATE `stockagefrigo` SET `nombrepoulet` = '$nombrepoulet', `cause` = '$cause',`commentaire` = '$commentaire'
            ,`datemortalite` = '$datemortalite',`idreceptionpoussin` = '$idreceptionpoussin' WHERE `idstockagefrigo` = ?;";
            //$result = $db->query($sql); 
            $sth = $db->prepare($sql);    
