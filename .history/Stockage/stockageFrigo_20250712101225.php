                            ...
                            <div class="card position-relative">
                                ...
                                <div class="row m-2">
                                    <div class="table-responsive">
                                        ...
                                        <a href=".php" class="btn btn-success w-lg bouton mt-5 mb-2 ml-5"><i class="fa fa-plus me-1"></i> Ajouter </a>
                                        <a href="ajouterStockagefrigoFormulaire.php?idreceptionpoussin=<?= $_GET['idreceptionpoussin'] ?>" class="btn btn-success w-lg bouton mt-5 mb-2 ml-5"><i class="fa fa-plus me-1"></i>Ajouter stockage</a>     
