<?php
    ...
    $pdf->SetTextColor(0,0,0);
    $pdf->SetFont('Arial','B',8);
    $pdf->Cell(50,5,utf8_decode("Prix d'achat"),1,0,'C');  
    $pdf->Cell(40,5,utf8_decode('Frais'),1,0,'C');
    $pdf->Cell(40,5,utf8_decode('Dette restante'),1,0,'C');
    $pdf->Cell(90,5,utf8_decode('Vente total'),1,1,'C');

    $pdf->Cell(50,5,utf8_decode($PrixAlimentTotal ),1,0,'C');
    $pdf->Cell(40,5,utf8_decode($vaccination['prix']),1,0,'C');
    $pdf->Cell(40,5,utf8_decode($vaccination['prix']),1,0,'C');
    $pdf->Cell(90,5,utf8_decode($vaccination['datevaccination']),1,1,'C');
