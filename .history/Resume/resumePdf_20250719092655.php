<?php
    ...
    if($Vente){
        ...
        $pdf->Cell(30,5,utf8_decode('Nombre de poulet'),1,0,'C');  
        $pdf->Cell(30,5,utf8_decode('Prix'),1,0,'C');
        $pdf->Cell(40,5,utf8_decode('Lieu de vente'),1,0,'C');
        $pdf->Cell(30,5,utf8_decode('Client'),1,0,'C');
        $pdf->Cell(50,5,utf8_decode('Date vente'),1,1,'C');

        foreach($Vente as $vente){ 
            $pdf->Cell(30,5,utf8_decode($vente['nombrepoulet']),1,0,'C');
            $pdf->Cell(30,5,utf8_decode($vente['prix']),1,0,'C');
            $pdf->Cell(35,5,utf8_decode($vente['lieuvente']),1,0,'C');
            $pdf->Cell(30,5,utf8_decode($vente['client']),1,0,'C');
            $pdf->Cell(50,5,utf8_decode($vente['datevente']),1,1,'C');

            $PrixVente +=  $vente['prix'];
        }
        $pdf->Cell(30,5,utf8_decode("Total"),1,0,'C');
        $pdf->Cell(30,5,utf8_decode($PrixVente),1,1,'C');
    }
