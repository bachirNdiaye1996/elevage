<?php
    ...
    if($Divers){
        ...
        $pdf->Cell(30,5,utf8_decode('Prix'),1,0,'C');
        $pdf->Cell(40,5,utf8_decode('Quantités'),1,0,'C');
        $pdf->Cell(30,5,utf8_decode('Client'),1,0,'C');
        $pdf->Cell(50,5,utf8_decode('Date dette'),1,1,'C');

        $PrixDivers=0;
        foreach($Divers as $divers){ 
            $pdf->Cell(30,5,utf8_decode($divers['nombrepoulet']),1,0,'C');
            $pdf->Cell(30,5,utf8_decode($divers['prix']),1,0,'C');
            $pdf->Cell(35,5,utf8_decode($divers['paye']),1,0,'C');
            $pdf->Cell(30,5,utf8_decode($divers['client']),1,0,'C');
            $pdf->Cell(50,5,utf8_decode($divers['dateachat']),1,1,'C');
