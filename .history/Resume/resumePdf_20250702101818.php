<?php
    ...
    $pdf->Cell(60,5,utf8_decode('Date de réception'),1,1,'C');
    ...
    foreach($Receptionpoussin as $receptionpoussin){ 
        ...
        $pdf->Cell(60,5,utf8_decode($receptionpoussin['datereception']),1,1,'C');
    ...
    $pdf->Cell(60,5,utf8_decode('Date Achat'),1,1,'C');
    ...
    foreach($Achataliments as $achataliment){ 
        ...
        $pdf->Cell(60,5,utf8_decode($achataliment['dateachat']),1,1,'C');
