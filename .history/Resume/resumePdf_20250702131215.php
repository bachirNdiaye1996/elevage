<?php
    ...
    if($Vaccination){
        ...
        foreach($Vaccination as $vaccination){ 
            $pdf->Cell(50,5,utf8_decode($vaccination['nombremort']),1,0,'C');
            $pdf->Cell(40,5,utf8_decode($vaccination['cause']),1,0,'C');
            $pdf->Cell(90,5,utf8_decode($vaccination['datemortalite']),1,1,'C');
