<?php
    ...
    $pdf->Cell(30,5,utf8_decode('Prix'),1,0,'C');
    $pdf->Cell(30,5,utf8_decode('Payabilité (remboursé)'),1,0,'C');
    $pdf->Cell(30,5,utf8_decode('Client'),1,0,'C');
    $pdf->Cell(90,5,utf8_decode('Date dette'),1,1,'C');

    $PrixDette=0;
    foreach($Dette as $dette){ 
        $pdf->Cell(30,5,utf8_decode($dette['nombresac']),1,0,'C');
        $pdf->Cell(30,5,utf8_decode($dette['prix']),1,0,'C');
        $pdf->Cell(30,5,utf8_decode($dette['fournisseur']),1,0,'C');
        $pdf->Cell(90,5,utf8_decode($dette['dateachat']),1,1,'C');
