<?php
    ...
    foreach($Achataliments as $achataliment){ 
        $pdf->Cell(30,5,utf8_decode($achataliment['nombrepoussin']),1,0,'C');
        $pdf->Cell(30,5,utf8_decode($achataliment['provenance']),1,0,'C');
        $pdf->Cell(30,5,utf8_decode($achataliment['prix']),1,0,'C');
        $pdf->Cell(130,5,utf8_decode($achataliment['datereception']),1,1,'C');
