<?php
    ...
    $pdf->Cell(50,5,utf8_decode('Vente total'),1,1,'C');

    $pdf->Cell(30,5,utf8_decode($PrixReceptionPoussinTotal ),1,0,'C');
    $pdf->Cell(30,5,utf8_decode($PrixAlimentTotal + $PrixDivers),1,0,'C');
    $pdf->Cell(40,5,utf8_decode($PrixDette),1,0,'C');
    $pdf->Cell(50,5,utf8_decode($vaccination['datevaccination']),1,1,'C');
