<?php
    ...
    if(isset($_POST['CreerReception'])){
        ...
        $insertUser=$db->prepare("INSERT INTO `receptionpoussin` (`idreceptionpoussin`, `datecreation`, `nombrepoussin`, `numerobande`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`, `etatbobine`,`nbbobineactuel`) 
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 ml-5 mr-5 mt-3">
                                                    <div class="mb-5 text-start">
                                                        ...
                                                        <input class="form-control" type="text" name="entetedf" value="" id="validationDefault01" placeholder="Mettez l'entete de la DF">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Nom complet du saisisseur</label>
                                                        <input class="form-control" type="text" name="nomrecepteur" value="" id="validationDefault02" required placeholder="Mettez le nom complet du saisisseur">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 ml-5 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Matricule du Camion</label>
                                                        <input class="form-control" type="text" name="matriculecamion" value="" id="validationDefault03" placeholder="Mettez le matricule du camion">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 ml-5 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">BL</label>
                                                        <input class="form-control" type="text" name="bl" value="" id="validationDefault058" placeholder="Mettez le numéro du BL">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 ml-5 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Poids pont bascule</label>
                                                        <input class="form-control" type="text" name="poidscamion" value="" id="validationDefault20" placeholder="Mettez le poids pont bascule">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mt-3 ml-5 mb-5">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Date de reception</label>
                                                        <input class="form-control" type="date" name="dateplanifie" value="" id="validationDefault25" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end">
                                                        ...
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="detailsReception.php ?>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
