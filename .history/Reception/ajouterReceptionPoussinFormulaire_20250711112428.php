<?php
    ...
    if(isset($_POST['CreerReception'])){
        ...
        $insertUser=$db->prepare("INSERT INTO `ficheachataliment` (`idficheachataliment`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichevaccination` (`idfichevaccination`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichevente` (`idfichevente`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichedette` (`idfichedette`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichedivers` (`idfichedivers`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichemortalite` (`idfichemortalite`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichestockagefrigo` (`idfichestockagefrigo`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));
