                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style=""> <?= $reception['nombrepoussin']/50 ?> </td>
                                                        <td style=""> <?= $reception['provenance'] ?> </td>
                                                        <td style=""> <?= $reception['prix'] ?> </td>
                                                        <td style=""> <?= $reception['prix']/($reception['nombrepoussin']/50) ?> </td>
                                                        ...
                                                        <td style="text-align: center;">
                                                                ...
                                                                <a href="modifierReception.php?idreceptionpoussin=<?= $reception['idreceptionpoussin'] ?>&idmatiereModifSimp=<?= $reception['idmatiere'] ?>&epaisseur=<?= $reception['epaisseur'] ?>&nombrebobine=<?= $reception['nbbobine'] ?>&lieutransfert=<?= $reception['lieutransfert'] ?>" class="px-2" title="Modifier la réception">
