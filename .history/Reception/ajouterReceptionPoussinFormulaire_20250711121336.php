<?php
    ...
    include "../connexion/conexiondb.php";
            ...
            //** Debut select des receptions idreceptionpoussin 
            $sql = "SELECT MAX(idreceptionpoussin) FROM receptionpoussin;";
            ...
            $MaxIDVal = (int) $MaxID['idreceptionpoussin']; 
    ...
    if(isset($_POST['CreerReception'])){
        ...
        //** Debut select des receptions
            $sql = "SELECT MAX(idreceptionpoussin) as idreceptionpoussin FROM receptionpoussin;";
        ...
        VALUES (NULL, ?, 1);");
        $insertUser->execute(array($MaxIDVal));
