                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style="">
                                                            <a style="text-decoration: none;" href="resumePdf.php?idreceptionpoussin=<?= $reception['idreceptionpoussin'] ?>" data-toggle="modal" title="Voir détails" class="link-offset-2 link-underline"><?= 'BANDE_0'.$reception['idreceptionpoussin'] ?></a> 
                                                        </td>
