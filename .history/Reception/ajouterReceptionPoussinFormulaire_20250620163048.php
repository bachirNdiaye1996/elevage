<?php
    ...
    if(isset($_POST['CreerReception'])){
        ...
        $insertUser=$db->prepare("INSERT INTO `receptionpoussin` (`idreceptionpoussin`, `epaisseur`, `poidsdeclare`, `poidspese`, `dateajout`, `user`,`nbbobine`,`lieutransfert`, `idreception`, `etatbobine`,`nbbobineactuel`) 
