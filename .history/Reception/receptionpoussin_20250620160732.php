                            ...
                            <div class="card position-relative">
                                ...
                                <div class="row m-2">
                                    <div class="table-responsive">
                                        ...
                                        <a href="ajouterReceptionFormulaire.php?idreception=<?= $_GET['idreceptionpoussin']?>" class="btn btn-success w-lg bouton"><i class="fa fa-plus me-1"></i> Ajouter réception</a>
