...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['modifierReception'])){
            ...
            $sql = "UPDATE `receptionpoussin` SET `nombrepoussin` = '$nombrepoussin', `provenance` = '$provenance', `prix` = '$prix',`commentaire` = '$commentaire',`datereception` = '$datereception'
             WHERE `idreceptionpoussin` = ?;";
            //$result = $db->query($sql); 
            $sth = $db->prepare($sql);    
            $sth->execute(array($id));

            header("location: receptionpoussin.php?idreceptionpoussin=$id");
            exit;
        } 
    }
//Fin modif
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 ml-5 mr-5 mt-3">
                                                    <div class="mb-5 text-start">
                                                        ...
                                                        <input class="form-control" type="text" name="nombrepoussin" value="<?php echo $row['nombrepoussin'];?>" id="validationDefault01" placeholder="Nombre de poussin">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Provenance</label>
                                                        <input class="form-control" type="text" name="provenance" value="<?php echo $row['provenance'];?>" id="validationDefault02" required placeholder="Mettez la provenance">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 ml-5 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Prix</label>
                                                        <input class="form-control" type="text" name="prix" value="<?php echo $row['prix'];?>" id="validationDefault03" placeholder="Mettez le prix">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mt-3 ml-5 mb-5">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Date de reception</label>
                                                        <input class="form-control" type="date" name="datereception" value="<?php echo $row['datereception'];?>" id="validationDefault25" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mb-1 text-start">
                                                        ...
                                                        <textarea class="form-control"  name="commentaire" rows="4" cols="50" placeholder="Commentaire en quelques mots ( pas obligatoire... )"><?php echo $row['nbbobine'];?>"</textarea>
                                                    </div>
                                                </div> 
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-6 text-start">
                                                    ...
                                                    <input class="form-control" type="number" name="nbbobine" id="validationDefault01"  id="example-date-input4" placeholder="Taper le nombre de bobine" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
