<?php
    ...
    if(isset($_POST['CreerReception'])){
        ...
        $insertUser=$db->prepare("INSERT INTO `ficheachataliment` (`idreceptionpoussin`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichevaccination` (`idreceptionpoussin`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichevente` (`idreceptionpoussin`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichedette` (`idreceptionpoussin`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichedivers` (`idreceptionpoussin`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichemortalite` (`idreceptionpoussin`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));

        $insertUser=$db->prepare("INSERT INTO `fichestockagefrigo` (`idreceptionpoussin`, `datecreation`, `nombrepoussin`, `provenance`, `datereception`,`actif`,`prix`, `commentaire`) 
        VALUES (NULL, current_timestamp(),?, ?, ?, 1, ?, ?);");
        $insertUser->execute(array($nombrepoussin,$provenance, $datereception, $prix,$commentaire));
