...
<?php
    ...
    if(isset($_POST['CreerDette'])){
        ...
        $insertUser=$db->prepare("INSERT INTO `dette` (`iddette`,`actif`,`nombrepoulet`,`prix`,`lieudette`,`vendeur`,`client`,`paye`,`idreceptionpoussin`,`commentaire`,`datedette`,`datecreation`) 
        VALUES (NULL, 1, ?, ?, ?, ?, ?, ?, ?, ?, ?, current_timestamp());");
        $insertUser->execute(array($nombrepoulet,$prix,$lieudette,$vendeur,$client,$paye,$idreceptionpoussin,$commentaire,$datedette));


        header("location: dette.php?idreceptionpoussin=$idreceptionpoussin");
        exit;
    }
                            ...
                            <div class="modal-dialog-centered">
                                <div class="modal-content col-lg-12">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myExtraLargeModalLabel">Ajouter une dette</h5>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                        ...
                                                        <input class="form-control" type="text" name="lieudette" value="" id="validationDefault02" required placeholder="Mettez le lieu de dette">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end">
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="dette.php?idreceptionpoussin=<?= $_GET['idreceptionpoussin'] ?>>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
