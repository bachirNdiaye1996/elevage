...
<?php
    ...
    if(isset($_POST['CreerDette'])){
        ...
        $insertUser=$db->prepare("INSERT INTO `dette` (`iddette`,`actif`,`nombrepoulet`,`prix`,`lieudette`,`vendeur`,`client`,`idreceptionpoussin`,`commentaire`,`datedette`,`datecreation`) 
        VALUES (NULL, 1, ?, ?, ?, ?, ?, ?, ?, ?, current_timestamp());");
        $insertUser->execute(array($nombrepoulet,$prix,$lieuvente,$vendeur,$client,$idreceptionpoussin,$commentaire,$datedette));
