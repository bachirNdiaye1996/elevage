                                            ...
                                            <div class="row">
                                                <div class="col-md-2 ml-5 mr-5 mt-3">
                                                    <div class="mb-5 text-start">
                                                        ...
                                                        <input class="form-control" type="text" name="nombrepoulet" value="" id="validationDefault01" placeholder="Nombre de poulet morts">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mr-2 mt-3">
                                                    <div class="mb-1 text-start">
                                                        <label class="form-label fw-bold" for="nom">Cause</label>
                                                        <input class="form-control" type="text" name="lieuvente" value="" id="validationDefault02" required placeholder="Mettez la cause de la mortalité">
                                                    </div>
                                                </div>
