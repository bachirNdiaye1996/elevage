<?php
    ...
    if(isset($_POST['CreerMortalite'])){
        ...
        $insertUser=$db->prepare("INSERT INTO `mortalite` (`idmortalite`,`actif`,`nombremort`,`cause`,`datemortalite`,`datecreation`,`idreceptionpoussin`,`commentaire`) 
        VALUES (NULL, 1, ?, ?, ?, current_timestamp(), ?, ?);");
        $insertUser->execute(array($nombremort,$cause,$datemortalite,$idreceptionpoussin,$commentaire));


        header("location: mortalite.php?idreceptionpoussin=$idreceptionpoussin");
        exit;
    }
                            ...
                            <div class="modal-dialog-centered">
                                <div class="modal-content col-lg-12">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myExtraLargeModalLabel">Ajouter une mortalité</h5>
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end">
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="mortalite.php?idreceptionpoussin=<?= $_GET['idreceptionpoussin'] ?>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
                                                            <input class="btn btn-success  w-lg bouton mr-3" name="CreerMortalite" type="submit" value="ENREGISTRER">
                                                        </div>
                                                        <hr/>
                                                    </div>
                                                </div>
