...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['modifierMortalite'])){
            $nombremort=htmlspecialchars($_POST['nombremort']);
            $cause=htmlspecialchars($_POST['cause']);
            $datemortalite=htmlspecialchars($_POST['datemortalite']);
            $commentaire=htmlspecialchars($_POST['commentaire']);
            $idreceptionpoussin=htmlspecialchars($_POST['idreceptionpoussin']);

            $sql = "UPDATE `vente` SET `nombremort` = '$nombremort', `cause` = '$cause',`commentaire` = '$commentaire'
            ,`datemortalite` = '$datemortalite',`idreceptionpoussin` = '$idreceptionpoussin' WHERE `idmortalite` = ?;";
            //$result = $db->query($sql); 
            $sth = $db->prepare($sql);    
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 ml-5 mr-5 mt-3">
                                                <div class="mb-5 text-start">
                                                    <label class="form-label fw-bold" for="nom">Nombre de mortalité</label> 
                                                    <input class="form-control" type="text" name="nombremort" value="" id="validationDefault01" placeholder="Nombre de poulet morts">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mr-2 mt-3">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Cause</label>
                                                    <input class="form-control" type="text" name="cause" value="" id="validationDefault02" required placeholder="Mettez la cause de la mortalité">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Date mortalité</label>
                                                    <input class="form-control" type="date" name="datemortalite" value="" id="validationDefault25" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 ml-5 mr-5 mt-3">
                                                <div class="mb-5 text-start">
                                                    ...
                                                    <input class="form-control" type="text" name="nombrepoulet" value="<?php echo $row['nombrepoulet'];?>" id="validationDefault01" placeholder="Nombre de poulet">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mr-2 mt-3">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Lieu de vente</label>
                                                    <input class="form-control" type="text" name="lieuvente" value="<?php echo $row['lieuvente'];?>" id="validationDefault02" required placeholder="Mettez le lieu de vente">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 mr-2 mt-3">
                                                <div class="mb-1 text-start">
                                                    ...
                                                    <input class="form-control" type="text" name="vendeur" value="<?php echo $row['vendeur'];?>" id="validationDefault02" required placeholder="Mettez le nom du vendeur">
                                                </div>
                                            </div>
                                            <div class="col-md-2 ml-5 mt-3">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Client</label>
                                                    <input class="form-control" type="text" name="client" value="<?php echo $row['client'];?>" id="validationDefault03" placeholder="Mettez le nom du client">
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                                    <label class="form-label fw-bold" for="nom">Date de vaccination</label>
                                                    <input class="form-control" type="date" name="datevente" value="<?php echo $row['datevente'];?>" id="validationDefault25" required>
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-3 ml-5 mb-5">
                                                <div class="mb-1 text-start">
                                            ...
                                            <div class="col-md-12 text-end">
                                                <div class="col-md-8 align-items-center col-md-12 text-end">
                                                    ...
                                                    <div class="d-flex gap-2 pt-4">                           
                                                        <a class="btn btn-danger  w-lg bouton mr-3" href="mortalite.php">Annuler</a>
                                                        <input class="btn btn-success  w-lg bouton mr-3" name="modifierMortalite" type="submit" value="Modifier">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
