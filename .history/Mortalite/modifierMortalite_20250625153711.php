...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['modifierMortalite'])){
            ...
            $sql = "UPDATE `vente` SET `nombrepoulet` = '$nombrepoulet', `lieuvente` = '$lieuvente', `prix` = '$prix',`commentaire` = '$commentaire'
            ,`datevente` = '$datevente',`vendeur` = '$vendeur',`client` = '$client',`idreceptionpoussin` = '$idreceptionpoussin' WHERE `idvente` = ?;";
            //$result = $db->query($sql); 
            $sth = $db->prepare($sql);    
