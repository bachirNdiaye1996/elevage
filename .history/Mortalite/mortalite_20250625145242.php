                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style=""> <?= $vente['cause'] ?> </td>
                                                        <td style=""> <?= $vente['datemortalite'] ?> </td>
                                                        <td style=""> <?= $vente['datecreation'] ?> </td>
                                                        <td style=""> <?= $vente['idreceptionpoussin'] ?> </td>
                                                        <td style="text-align: center;">
                                                            <a href="modifierMortalite.php?idmortalite=<?= $vente['idmortalite'] ?>" class="px-2" title="Modifier la mortalité"><i class="far fa-edit"></i></a>
                                                                ...
                                                                $('.suprimerMortalite<?= $i ?>').click(function(e) {
                                                                    ...
                                                                    confirmButtonText: "Suprimer la mortalite",
                                                                        ...
                                                                        if (result.isConfirmed) {                                                                                                                  
                                                                            $.ajax({
                                                                                    type: "POST",
                                                                                    url: 'supressionVente.php?idmortalite=<?= $vente['idmortalite'] ?>',
                                                                                    //data: str,
